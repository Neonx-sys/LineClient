    ...
    public void event(Event e) {
        if (e instanceof EventRender) {
            ...
            if (watermark.get()) {
                ...
                float nobyWidth = Fonts.gilroyBold[20].getWidth("YOUGAME ");
                ...
                Fonts.gilroyBold[20].drawString(((EventRender) e).getMatrixStack(), "YOUGAME ", currentX, watermarkY + 4.5f, new Color(ClickGUI.getThemeColors()[4].getColor().getRed(), ClickGUI.getThemeColors()[4].getColor().getGreen(), ClickGUI.getThemeColors()[4].getColor().getBlue(), (int)(watermarkAlpha * 255)).getRGB());
                currentX += nobyWidth;
