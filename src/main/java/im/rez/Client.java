...
public class Client {
    public static String name = "from rez and exlenty <3";
    ...
    public static void addChatMessage(String msg) {
        mc.ingameGUI.getChatGUI().printChatMessage(new TranslationTextComponent(TextFormatting.BLUE + "YOUGAME" + TextFormatting.GRAY + " -> " + TextFormatting.RESET + msg));
    }
