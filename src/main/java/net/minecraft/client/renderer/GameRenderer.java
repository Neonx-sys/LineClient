...
public class GameRenderer implements IResourceManagerReloadListener, AutoCloseable
{
    ...
    public CachedBlockInfo getCamera() {
        BlockPos blockPos = new BlockPos(mc.player.getPosX(), mc.player.getPosY() + mc.player.getEyeHeight(), mc.player.getPosZ());
        return new CachedBlockInfo(mc.world, blockPos, true);
    }
