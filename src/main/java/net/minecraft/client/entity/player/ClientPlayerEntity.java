...
public class ClientPlayerEntity extends AbstractClientPlayerEntity
{
    ...
    public void tick()
    {
        Events.eventTick = new EventTick();
        Events.events(Events.eventTick);
    ...
    private void onUpdateWalkingPlayer()
    {
        ...
        Events.eventRotation = new EventRotation(this.rotationYaw, this.rotationPitch);
        Events.events(Events.eventRotation);
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            double d2 = (double)(Events.eventRotation.getYaw() - this.lastReportedYaw);
            double d3 = (double)(Events.eventRotation.getPitch() - this.lastReportedPitch);
            ...
            if (this.isPassenger())
            {
                ...
                this.connection.sendPacket(new CPlayerPacket.PositionRotationPacket(vector3d.x, -999.0D, vector3d.z, Events.eventRotation.getYaw(), Events.eventRotation.getPitch(), this.onGround));
                flag1 = false;
            }
            else if (flag1 && flag2)
            {
                this.connection.sendPacket(new CPlayerPacket.PositionRotationPacket(this.getPosX(), this.getPosY(), this.getPosZ(), Events.eventRotation.getYaw(), Events.eventRotation.getPitch(), this.onGround));
            }
            else if (flag1)
            {
            ...
            {
                this.connection.sendPacket(new CPlayerPacket.RotationPacket(Events.eventRotation.getYaw(), Events.eventRotation.getPitch(), this.onGround));
            }
            ...
            if (flag2)
            {
                this.lastReportedYaw = Events.eventRotation.getYaw();
                this.lastReportedPitch = Events.eventRotation.getPitch();
            }
